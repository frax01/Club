...
class _ClubPageState extends State<ClubPage> {
  ...
  Future<void> createEvent(String event, String imagePath, String clubClass,
      String startDate, String endDate, String description, String level) async {
    try {
      if (event == "") {
        ScaffoldMessenger.of(context).showSnackBar(
      ...
      await firestore
          .collection('${section.toLowerCase()}_$level')
          .add({
        'title': event,
    ...
    return Scaffold(
      ...
      body: Center(
        child: _selectedLevel == "home"
            ...
            : SettingsPage(id: widget.document["id"], document: widget.document,)
      ),
      //drawer: Drawer(
      //  width: width > 700
      //      ? width / 3
      ...
      //  ),
      //),
      floatingActionButton: widget.document['status'] == 'Admin' && _selectedLevel=='home'
